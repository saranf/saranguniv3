...
<div class="flexsearch">
		<div class="flexsearch--wrapper">
			<form class="flexsearch--form" action="index.php" method="post">
				<div class="flexsearch--input-wrapper">
					<input class="flexsearch--input" type="search" name="searchText" placeholder="search" value="<?php echo isset($searchText)?$searchText:null?>">
				</div>
...
<!-- 서치박스끝 -->
	...
	<article class="boardArticle">
		<div id="boardList">
			<table>
				<caption class="readHide"><b><font size="5">게시판</font></b></caption>
				<thead>
					<tr>
