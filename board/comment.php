	...
	<table>
		<tbody>
			<tr>
				...
				<td><input type="text" name="coId" id="coId" size="50"></td>
			</tr>
			<tr>
				<th scope="row">
			<label for="coPassword">비밀번호</label></th>
				<td><input type="password" name="coPassword" id="coPassword" size="50"></td>
			</tr>
			<tr>
				<th scope="row"><label for="coContent">내용</label></th>
				<td><textarea name="coContent" id="coContent" rows="2" cols="80"></textarea></td>
			</tr>
			<tr>
				<td colspan="2" align=right><div class="btnSet">
