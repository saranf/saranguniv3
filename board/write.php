				...
				<table id="boardWrite">
					...
					<tbody>
						<tr>
							...
							<td class="id">
								...
								if(isset($bNo)) {
									...
									<input type="text" name="bID" id="bID" size="50">
								<?php } ?>
							</td>
						</tr>
						<tr>
							<th scope="row"><label for="bPassword">비밀번호</label></th>
							<td class="password"><input type="password" size="50" name="bPassword" id="bPassword"></td>
						</tr>
						<tr>
						...
						<tr>
							...
							<td class="content"><textarea name="bContent" id="bContent" rows="8" cols="90"><?php echo isset($row['b_content'])?$row['b_content']:null?></textarea></td>
						</tr>
					</tbody>
				</table>
				<div class="btnSet">
